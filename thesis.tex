...
\newcommand{\thesistitle}{Transforming Conceptual BPMN Process Models into Efficient Executable Workflows} % The title of the thesis. The English version should be used, if it exists.
...
\setdate{07}{08}{2022} % Set date with 3 arguments: {day}{month}{year}.
...
\input{sections/acknowledgements.tex} % A short introduction to LaTeX.
...
\input{sections/automating-business-processes.tex}

\chapter{Evaluating and Optimizing Executable Process Models}
\input{sections/evaluation-and-optimization.tex}

\chapter{Concept and Implementation}
\input{sections/concept-and-implementation.tex}
